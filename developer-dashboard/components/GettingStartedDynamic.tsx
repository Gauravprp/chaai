...
import type { Endpoint, Documentation } from '@/services/apiDocumentationService';

interface GettingStartedDynamicProps {
  endpoint?: Endpoint;
  documentation: Documentation;
}

const GettingStartedDynamic: React.FC<GettingStartedDynamicProps> = ({ endpoint, documentation }) => {
